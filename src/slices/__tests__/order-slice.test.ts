...
describe('Слайс заказов', () => {
  ...
  describe('Действия', () => {
    it('Обрабатывает закрытие модального окна заказа', () => {
      const initialStateWithModal: OrderState = {
        ...initialState,
  ...
  describe('Селекторы', () => {
    ...
    describe('orderDataSelector', () => {
      ...
      it('Возвращает null, если данные не найдены', () => {
        const selector = selectOrderDataByNumber('999');
        const state = {
          ...mockRootState,
